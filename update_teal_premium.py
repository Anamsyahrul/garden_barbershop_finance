              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text('Bagian Capster', style: TextStyle(color: Colors.white.withValues(alpha: 0.9), fontWeight: FontWeight.w600, fontSize: 13)),
                    ),
          ...
          Column(
            ...
            children: [
              Row(
                children: [
                  Container(
                    ...
                    child: const Center(
                      child: Icon(Icons.content_cut_rounded, color: Colors.white, size: 26),
                    ),
                  ),
                  const Spacer(),
                  Container(
                    ...
                    child: const Text(
                      'FINANCE',
                      style: TextStyle(color: AppColors.tealDark, fontWeight: FontWeight.w900, fontSize: 10, letterSpacing: 1.5),
                    ),
                  ),
                ],
              ),
              ...
              Text(
                ...
                style: TextStyle(color: Colors.white.withValues(alpha: 0.85), fontSize: 13, fontWeight: FontWeight.w500, height: 1.4),
              ),
            ],
          ),
        ],
...
print("Banners updated to original color scheme with premium layout.")
