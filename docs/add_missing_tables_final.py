...
out_path = r'c:\laragon\www\garden barbershop\garden_barbershop_finance\docs\Proposal Skripsi v2_final.docx'
...
if target_p:
    current_element = target_p._p.getnext()
...
doc.save(out_path)
print("Saved to Proposal Skripsi v2_final.docx successfully.")
