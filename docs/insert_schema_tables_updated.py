...
out_path = r'c:\laragon\www\garden barbershop\garden_barbershop_finance\docs\Proposal Skripsi v2_updated.docx'
...
for p in doc.paragraphs:
    text = p.text.strip()
    if text.startswith('1. Collection') or text.startswith('2. Collection') or text.startswith('3. Collection') or text.startswith('4. Collection') or text.startswith('5. Collection') or text.startswith('6. Collection'):
        p.clear()
